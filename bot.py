...
TU_TUT_FIRST = [
    ...
    "Да, да.", "это ты? привеет", "Ага.", "Здравствуй.", "тут, не переживай."
]

TU_TUT_SECOND = [
    "Держись, я рядом.", "Я с тобой.", "всё вроде хорошо даже", "Не хочу сегодня.", "Сегодня не буду.",
    "Я рядом.", "Держись.", "Всё будет нормально.", "Че как ты, лошара?", "я с тобой если че"
]
...
Перезагружает вегетативную нервную систему, снимает напряжение.""",
    ...
    """🥜 ПОЕШЬ В КОНЦЕ КОНЦОВ
    
Горсть орехов, кусок сыра или яйцо.
...
20 отжиманий, приседаний или подтягиваний до отказа. Покричи, не знаю.
...
async def handle_heavy(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "💪 Упражнение — быстрые техники самопомощи\n"

...
HELP_TECHNIQUES = [
    ...
    "🎵 3 минуты любимой музыки на полной громкости. Звук активирует эмоциональные центры.",
    "🧘 Сядь, закрой глаза, просто наблюдай за мыслями. Через 5 минут тяга уйдёт.",
    "📖 Прочитай 2 страницы сложной книги. Нагрузи мозг — он забудет про желание."
]
